...
python main.py --model-name $model_name --dataset-name $ds_name3 --device cuda:0 --num-in-context-samples 5 --data-dir $data_dir --results-dir $results_dir --calibration-num-steps 200 --baseline-methods seq_likelihood cot_seq_likelihood cot_qual_verbalized_uncertainty ps_seq_likelihood ts_seq_likelihood 
