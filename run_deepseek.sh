...
python main.py --model-name $model_name_1 --dataset-name $ds_name3 --num-in-context-samples 10 --data-dir $data_dir --results-dir $results_dir --calibration-num-steps 200 --baseline-methods cot_qual_verbalized_uncertainty qual_verbalized_uncertainty
