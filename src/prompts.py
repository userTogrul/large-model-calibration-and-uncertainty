...
SLOW_THINKING_PROMPT = "You will think step by step about the following question and answer."
...
MEAN_DECISIVENESS_VERBALIZED_CONF_PROMPT = f".\nPlease provide your confidence in the answer only as one of {' / '.join([f'{exp}' for exp in MEAN_DECISIVENESS_SCALE.keys()])}: "
