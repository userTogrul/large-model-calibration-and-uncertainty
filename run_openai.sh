...
model_name_1="gpt-4o"
model_name_2="gpt-4"
model_name_3="gpt-5.2"
model_name_4="gpt-5.5"
model_name_5="o4-mini"
ds_name1="trivia_qa"
...
python main.py --model-name $model_name_3 --dataset-name $ds_name1 --num-in-context-samples 10 --data-dir $data_dir --results-dir $results_dir --calibration-num-steps 200 --baseline-methods cot_qual_verbalized_uncertainty qual_verbalized_uncertainty
# python main.py --model-name $model_name_1 --dataset-name $ds_name1 --num-in-context-samples 10 --data-dir $data_dir --results-dir $results_dir --calibration-num-steps 200 --baseline-methods seq_likelihood cot_seq_likelihood cot_qual_verbalized_uncertainty ps_seq_likelihood ts_seq_likelihood
...
# python main.py --model-name $model_name_3 --dataset-name $ds_name1 --num-in-context-samples 10 --data-dir $data_dir --results-dir $results_dir --calibration-num-steps 200 --baseline-methods semantic_entropy
